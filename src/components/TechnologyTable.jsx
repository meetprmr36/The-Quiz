      ...
      <table className="whole-table w-full border-collapse bg-[var(--white)]">
        <thead className="Table-head sticky top-0 z-20">
          <tr className="text-left">
            ...
            <th 
            className="p-3 w-[15%] bg-[var(--Gray)] max-lg:w-[20%] max-sm:text-xs max-sm:w-[40%]">Created Date</th>
            <th 
            className="p-3 w-[15%] bg-[var(--Gray)] max-lg:w-[20%] max-sm:text-xs max-sm:w-[30%]">Status</th>
            <th 
            className="p-3 w-[10%] bg-[var(--Gray)] max-lg:w-[15%] max-sm:text-xs max-sm:w-[25%]">Questions</th>
            <th 
            className="p-3 w-[15%] px-10 bg-[var(--Gray)] max-lg:w-[15%] max-lg:px-5 max-sm:text-xs max-sm:w-[30%]">Actions</th>
          </tr>
        </thead>
