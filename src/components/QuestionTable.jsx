      ...
      <table className="w-full border-collapse table-fixed">
        <thead className="Table-head sticky top-0 z-20">
          <tr className="text-left">
            ...
            <th className="p-3  w-[10%] max-lg:w-[20%] text-center max-md:w-[15%] max-md:text-sm max-sm:w-35">Status</th>
            <th className="p-3 w-[15%] text-center max-lg:w-[20%] max-lg:text-center max-md:w-[15%] max-md:text-sm max-sm:w-25">Options</th>
            <th className="p-3 px-10 w-[10%] max-lg:w-[15%] max-md:w-[15%] max-md:text-sm max-sm:w-35">Actions</th>
          </tr>
        </thead>
